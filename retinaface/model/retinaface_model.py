...
def load_weights(model):
    ...
    model_path = app_path + '/models/retinaface.h5'

    if not os.path.isfile(model_path):
        if not os.path.exists(app_path+"/models"):
            os.mkdir(app_path+"/models")
            print("Directory ",app_path,"/models created")
    ...
    if os.path.isfile(model_path) != True:
        raise ValueError("Pre-trained weight could not be loaded!"
            ...
            + " and copy it to the ", model_path, "manually.")
